    ...
    angular.module("mgcrea.ngStrap", ["mgcrea.ngStrap.modal", "mgcrea.ngStrap.aside", "mgcrea.ngStrap.alert", "mgcrea.ngStrap.button", "mgcrea.ngStrap.select", "mgcrea.ngStrap.datepicker", "mgcrea.ngStrap.timepicker", "mgcrea.ngStrap.navbar", "mgcrea.ngStrap.tooltip", "mgcrea.ngStrap.popover", "mgcrea.ngStrap.dropdown", "mgcrea.ngStrap.typeahead", "mgcrea.ngStrap.scrollspy", "mgcrea.ngStrap.affix", "mgcrea.ngStrap.tab", "mgcrea.ngStrap.collapse"]), angular.module("mgcrea.ngStrap.affix", ["mgcrea.ngStrap.helpers.dimensions", "mgcrea.ngStrap.helpers.debounce"]).provider("$affix", function () {
        ...
        this.$get = ["$window", "debounce", "dimensions", function (t, n, a) {
            function o(o, s) {
                ...
                var d = {}, f = angular.extend({}, e, s), p = f.target, g = "affix affix-top affix-bottom", m = !1, $ = 0, h = 0, v = 0, y = 0, w = null, b = null, D = o.parent();
        ...
        var e = this.defaults = {animation: "am-collapse", disallowToggle: !1, activeClass: "in", startCollapsed: !1}, t = this.controller = function (t, n, a) {
            ...
            o.$options = angular.copy(e), angular.forEach(["animation", "disallowToggle", "activeClass", "startCollapsed"], function (e) {
                ...
                var t = o.$targets.indexOf(e), n = o.$targets.$active;
                o.$targets.splice(t, 1), n > t ? n-- : t === n && n === o.$targets.length && n--, o.$setActive(n)
        ...
        n.defaults;
        return {
            require: ["?ngModel", "bsCollapse"], controller: ["$scope", "$element", "$attrs", n.controller], link: function (e, t, n, a) {
                var o = a[0], i = a[1];
        ...
        return {
            restrict: "EAC", require: "ngModel", link: function (e, t, n, s) {
                ...
                }, m = o({format: d.dateFormat, lang: p, strict: d.strictFormat});
                angular.forEach(["minDate", "maxDate"], function (e) {
                    angular.isDefined(n[e]) && n.$observe(e, function (t) {
                        f.$options[e] = m.getDateForAttribute(e, t), !isNaN(f.$options[e]) && f.$build(!1), u(s.$dateValue)
                    })
                    ...
                    var t;
                    return t = angular.isUndefined(e) || null === e ? 0 / 0 : angular.isDate(e) ? e : "string" === d.dateType ? m.parse(e, null, d.modelDateFormat) : new Date("unix" === d.dateType ? 1e3 * e : e), s.$dateValue = t, c()
                }), s.$render = function () {
                    t.val(c())
            ...
            return function (i) {
                var r = i.$scope, s = i.$options, l = s.lang, u = function (e, t) {
                    ...
                    format: s.dayFormat, split: 7, steps: {month: 1}, update: function (e, t) {
                        ...
                        var n = new Date(m.year, m.month, 1), a = n.getTimezoneOffset(), o = new Date(+n - 864e5 * t(n.getDay() - s.startWeek, 7)), l = o.getTimezoneOffset(), d = (new Date).toDateString();
                    ...
                    name: "month", format: s.monthFormat, split: 4, steps: {year: 1}, update: function (e) {
                        this.built && e.getFullYear() === m.year ? e.getMonth() !== m.month && (angular.extend(m, {
                            month: i.$date.getMonth(),
                            date: i.$date.getDate()
                        }), i.$updateSelected()) : (angular.extend(m, {year: i.$date.getFullYear(), month: i.$date.getMonth(), date: i.$date.getDate()}), i.$build())
                    }, build: function () {
                        for (var t, n = (new Date(m.year, 0, 1), []), a = 0; 12 > a; a++)t = new Date(m.year, a, 1), n.push({
                            date: t,
                    ...
                    name: "year", format: s.yearFormat, split: 4, steps: {year: 12}, update: function (e, t) {
                        !this.built || t || parseInt(e.getFullYear() / 20, 10) !== parseInt(m.year / 20, 10) ? (angular.extend(m, {
                            ...
                            month: i.$date.getMonth(),
                            date: i.$date.getDate()
                        }), i.$build()) : e.getFullYear() !== m.year && (angular.extend(m, {year: i.$date.getFullYear(), month: i.$date.getMonth(), date: i.$date.getDate()}), i.$updateSelected())
                    }, build: function () {
        ...
        return {
            restrict: "EAC", scope: !0, link: function (e, t, a) {
                var o = {scope: e};
        ...
        this.$get = ["$locale", "dateFilter", function (r, s) {
            var l = function (l) {
                ...
                var f, p, g = angular.extend({}, i, l), m = {}, $ = {
                    sss: "[0-9]{3}",
                    ss: "[0-5][0-9]",
                ...
                return m.init = function () {
                    m.$format = r.DATETIME_FORMATS[g.format] || g.format, f = d(m.$format), p = u(m.$format)
                }, m.isValid = function (e) {
                    return angular.isDate(e) ? !isNaN(e.getTime()) : f.test(e)
                }, m.parse = function (t, n, a) {
                    a && (a = r.DATETIME_FORMATS[a] || a), angular.isDate(t) && (t = s(t, a || m.$format));
                    var o = a ? d(a) : f, i = a ? u(a) : p, l = o.exec(t);
                    if (!l)return !1;
                    for (var c = (new e).fromDate(n && !isNaN(n.getTime()) ? n : new Date(1970, 0, 1, 0)), g = 0; g < l.length - 1; g++)i[g] && i[g].call(c, l[g + 1]);
                    var $ = c.toDate();
        ...
        this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$timeout", "$sce", "dimensions", function (n, a, o, i, r, s, l, u, c) {
            function d(t) {
                ...
                function i() {
                    w.$emit(d.prefixEvent + ".hide", u), v.removeClass(d.prefixClass + "-open"), d.animation && v.removeClass(d.prefixClass + "-with-" + d.animation)
                }
                ...
                var u = {}, d = u.$options = angular.extend({}, e, t);
                u.$promise = g(d.template);
                var w = u.$scope = d.scope && d.scope.$new() || a.$new();
                d.element || d.container || (d.container = "body"), m(["title", "content"], function (e) {
                ...
                }, u.$isShown = w.$isShown = !1, d.contentTemplate && (u.$promise = u.$promise.then(function (e) {
                    var n = angular.element(e);
                ...
                var b, D, k = angular.element('<div class="' + d.prefixClass + '-backdrop"/>');
                return u.$promise.then(function (e) {
                    angular.isObject(e) && (e = e.data), d.html && (e = e.replace(y, 'ng-bind-html="')), e = $.apply(e), b = o(e), u.init()
                }), u.init = function () {
                    d.show && w.$$postDigest(function () {
                        u.show()
                    })
                }, u.destroy = function () {
                    D && (D.remove(), D = null), k && (k.remove(), k = null), w.$destroy()
                }, u.show = function () {
                    if (!u.$isShown && !w.$emit(d.prefixEvent + ".show.before", u).defaultPrevented) {
                        var e, t;
                        angular.isElement(d.container) ? (e = d.container, t = d.container[0].lastChild ? angular.element(d.container[0].lastChild) : null) : d.container ? (e = p(d.container), t = e[0].lastChild ? angular.element(e[0].lastChild) : null) : (e = null, t = d.element), D = u.$element = b(w, function () {
                        }), D.css({display: "block"}).addClass(d.placement), d.animation && (d.backdrop && k.addClass(d.backdropAnimation), D.addClass(d.animation)), d.backdrop && l.enter(k, v, null);
                        var a = l.enter(D, e, t, n);
                        a && a.then && a.then(n), u.$isShown = w.$isShown = !0, f(w);
                        var o = D[0];
                        h(function () {
                            o.focus()
                        }), v.addClass(d.prefixClass + "-open"), d.animation && v.addClass(d.prefixClass + "-with-" + d.animation), d.backdrop && (D.on("click", r), k.on("click", r), k.on("wheel", s)), d.keyboard && D.on("keyup", u.$onKeyUp)
                    }
                }, u.hide = function () {
                    if (u.$isShown && !w.$emit(d.prefixEvent + ".hide.before", u).defaultPrevented) {
                        var e = l.leave(D, i);
                        e && e.then && e.then(i), d.backdrop && l.leave(k), u.$isShown = w.$isShown = !1, f(w), d.backdrop && (D.off("click", r), k.off("click", r), k.off("wheel", s)), d.keyboard && D.off("keyup", u.$onKeyUp)
                    }
                }, u.toggle = function () {
            ...
            var m = angular.forEach, $ = String.prototype.trim, h = n.requestAnimationFrame || n.setTimeout, v = angular.element(n.document.body), y = /ng-bind="/gi, w = {};
            return d
        }]
        ...
        this.$get = ["$window", "$document", "$rootScope", "dimensions", "debounce", "throttle", function (a, o, i, r, s, l) {
            ...
            function c(o) {
                ...
                var h, v, y, w, b, D, k, T, S = {}, x = S.$trackedElements = [], C = [];
                return S.init = function () {
                    this.$$count = 1, w = s(this.checkPosition, c.debounce), b = l(this.checkPosition, c.throttle), m.on("click", this.checkPositionWithEventLoop), d.on("resize", w), m.on("scroll", b), D = s(this.checkOffsets, c.debounce), h = i.$on("$viewContentLoaded", D), v = i.$on("$includeContentLoaded", D), D(), $ && (e[$] = S)
                }, S.destroy = function () {
                    this.$$count--, this.$$count > 0 || (m.off("click", this.checkPositionWithEventLoop), d.off("resize", w), m.off("scroll", b), h(), v(), $ && delete e[$])
                }, S.checkPosition = function () {
                    if (C.length) {
                        if (T = (g ? a.pageYOffset : m.prop("scrollTop")) || 0, k = Math.max(a.innerHeight, f.prop("clientHeight")), T < C[0].offsetTop && y !== C[0].target)return S.$activateElement(C[0]);
                        for (var e = C.length; e--;)if (!angular.isUndefined(C[e].offsetTop) && null !== C[e].offsetTop && y !== C[e].target && !(T < C[e].offsetTop || C[e + 1] && T > C[e + 1].offsetTop))return S.$activateElement(C[e])
                    }
                    ...
                    x.push({target: e, source: t})
                }, S.untrackElement = function (e, t) {
                    for (var n, a = x.length; a--;)if (x[a].target === e && x[a].source === t) {
                        n = a;
                        break
                    }
                    x = x.splice(n, 1)
        ...
        this.$get = ["$window", "$document", "$rootScope", "$tooltip", "$timeout", function (t, n, a, o, i) {
            function r(t, n, a) {
                ...
                r = o(t, s);
                var u = r.$scope;
                u.$matches = [], u.$activeIndex = 0, u.$isMultiple = s.multiple, u.$showAllNoneButtons = s.allNoneButtons && s.multiple, u.$iconCheckmark = s.iconCheckmark, u.$allText = s.allText, u.$noneText = s.noneText, u.$activate = function (e) {
        ...
        var o = n.defaults;
        return {
            require: ["?ngModel", "bsTabs"], transclude: !0, scope: !0, controller: ["$scope", "$element", "$attrs", n.controller], templateUrl: function (e, t) {
        ...
        this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$sce", "dimensions", "$$rAF", "$timeout", function (n, a, o, i, r, s, l, u, c, d, f) {
            function p(n, i) {
                ...
                function s() {
                    return O.$emit(P.prefixEvent + ".hide", F), U && "focus" === P.trigger ? n[0].blur() : void A()
                }
                ...
                function T() {
                    f(function () {
                        R.on("click", x), w.on("click", F.hide), W = !0
                    }, 0, !1)
                }
                ...
                function C(e) {
                    e = e || P.target || n;
                    var t = e[0], a = t.getBoundingClientRect();
                    null === a.width && (a = angular.extend({}, a, {width: a.right - a.left, height: a.bottom - a.top}));
                    var o;
                    return o = "body" === P.container ? c.offset(t) : c.position(t), angular.extend({}, a, o)
                }
                ...
                function E(e, t) {
                    R.css({top: e + "px", left: t + "px"})
                }

                function A() {
                    clearTimeout(I), F.$isShown && null !== R && (P.autoClose && S(), P.keyboard && k()), K && (K.$destroy(), K = null), R && (R.remove(), R = F.$element = null)
                }

                var F = {}, V = n[0].nodeName.toLowerCase(), P = F.$options = angular.extend({}, e, i);
                ...
                if (P.delay && angular.isString(P.delay)) {
                    ...
                    P.delay = H.length > 1 ? {show: H[0], hide: H[1]} : H[0]
                }
                P.title && (O.title = u.trustAsHtml(P.title)), O.$setEnabled = function (e) {
                ...
                P.contentTemplate && (F.$promise = F.$promise.then(function (e) {
                    ...
                    return $(P.contentTemplate).then(function (e) {
                        ...
                        return n.length || (n = m('[ng-bind="title"]', t[0])), n.removeAttr("ng-bind").html(e), t[0].outerHTML
                    })
                }));
                var L, R, q, Y, K;
                F.$promise.then(function (e) {
                    angular.isObject(e) && (e = e.data), P.html && (e = e.replace(y, 'ng-bind-html="')), e = h.apply(e), q = e, L = o(e), F.init()
                }), F.init = function () {
                    P.delay && angular.isNumber(P.delay) && (P.delay = {
                        show: P.delay,
                        hide: P.delay
                    }), "self" === P.container ? Y = n : angular.isElement(P.container) ? Y = P.container : P.container && (Y = m(P.container)), p(), P.target && (P.target = angular.isElement(P.target) ? P.target : m(P.target)), P.show && O.$$postDigest(function () {
                        "focus" === P.trigger ? n[0].focus() : F.show()
                    })
                }, F.destroy = function () {
                    b(), A(), O.$destroy()
                }, F.enter = function () {
                    return clearTimeout(I), N = "in", P.delay && P.delay.show ? void(I = setTimeout(function () {
                        "in" === N && F.show()
                    }, P.delay.show)) : F.show()
                }, F.show = function () {
                    if (P.bsEnabled && !F.$isShown) {
                        ...
                        var e, t;
                        P.container ? (e = Y, t = Y[0].lastChild ? angular.element(Y[0].lastChild) : null) : (e = null, t = n), R && A(), K = F.$scope.$new(), R = F.$element = L(K, function () {
                        }), R.css({
                            top: "-9999px",
                            left: "-9999px",
                            display: "block",
                            visibility: "hidden"
                        }), P.animation && R.addClass(P.animation), P.type && R.addClass(P.prefixClass + "-" + P.type), P.customClass && R.addClass(P.customClass);
                        var a = l.enter(R, e, t, r);
                        a && a.then && a.then(r), F.$isShown = O.$isShown = !0, g(O), d(function () {
                            F.$applyPlacement(), R && R.css({visibility: "visible"})
                        }), P.keyboard && ("focus" !== P.trigger && F.focus(), D()), P.autoClose && T()
                    }
                }, F.leave = function () {
                    return clearTimeout(I), N = "out", P.delay && P.delay.hide ? void(I = setTimeout(function () {
                        "out" === N && F.hide()
                    }, P.delay.hide)) : F.hide()
                };
                var U;
                F.hide = function (e) {
                    if (F.$isShown) {
                        O.$emit(P.prefixEvent + ".hide.before", F), U = e;
                        var t = l.leave(R, s);
                        t && t.then && t.then(s), F.$isShown = O.$isShown = !1, g(O), P.keyboard && null !== R && k(), P.autoClose && null !== R && S()
                    }
                }, F.toggle = function () {
                    ...
                    if (R) {
                        var a = P.placement, o = /\s?auto?\s?/i, i = o.test(a);
                        i && (a = a.replace(o, "") || e.placement), R.addClass(P.placement);
                        var r = C(), s = R.prop("offsetWidth"), l = R.prop("offsetHeight");
                        if (i) {
                            var u = a, c = P.container ? angular.element(t.querySelector(P.container)) : n.parent(), d = C(c);
                            u.indexOf("bottom") >= 0 && r.bottom + l > d.bottom ? a = u.replace("bottom", "top") : u.indexOf("top") >= 0 && r.top - l < d.top && (a = u.replace("top", "bottom")), ("right" === u || "bottom-left" === u || "top-left" === u) && r.right + s > d.width ? a = "right" === u ? "left" : a.replace("left", "right") : ("left" === u || "bottom-right" === u || "top-right" === u) && r.left - s < d.left && (a = "left" === u ? "right" : a.replace("right", "left")), R.removeClass(u).addClass(a)
                        }
                        var f = M(a, r, s, l);
                        E(f.top, f.left)
                    }
                    ...
                    e.preventDefault(), e.stopPropagation(), F.$isShown ? n[0].blur() : n[0].focus()
                };
                var W = !1;
                return F
            }
        ...
        var r = o.defaults;
        return {
            restrict: "EAC", require: "ngModel", link: function (e, t, a, s) {
                var l = {scope: e};
                ...
                e.$watch(a.ngModel, function (t) {
                    e.$modelValue = t, p.valuesFn(e, s).then(function (e) {
                        ...
                        var n = g.$isVisible();
                        n && g.update(e), (1 !== e.length || e[0].value !== t) && (!n && g.update(e), s.$render())
                    })
                }), s.$formatters.push(function (e) {
                    ...
                    var e = g.$getIndex(s.$modelValue), n = angular.isDefined(e) ? g.$scope.$matches[e].label : s.$viewValue;
                    n = angular.isObject(n) ? p.displayValue(n) : n, t.val(n ? n.toString().replace(/<(?:.|\n)*?>/gm, "").trim() : "")
                }, e.$on("$destroy", function () {
                    g && g.destroy(), l = null, g = null
                })
            }
        }
        ...
        this.$get = ["$window", "$document", "$rootScope", "$sce", "$dateFormatter", "$tooltip", "$timeout", function (t, n, a, o, i, r, s) {
            function l(t, n, a) {
                ...
                var d = r(t, angular.extend({}, e, a)), f = a.scope, p = d.$options, g = d.$scope, m = p.lang, $ = function (e, t) {
                    return i.formatDate(e, t, m)
                }, h = 0, v = n.$dateValue || new Date, y = {
                    hour: v.getHours(),
                    meridian: v.getHours() < 12,
                    minute: v.getMinutes(),
                    second: v.getSeconds(),
                    millisecond: v.getMilliseconds()
                }, w = i.getDatetimeFormat(p.timeFormat, m), b = i.hoursFormat(w), D = i.timeSeparator(w), k = i.minutesFormat(w), T = i.showAM(w);
                g.$iconUp = p.iconUp, g.$iconDown = p.iconDown, g.$select = function (e, t) {
                    ...
                    for (e = 0; e < p.length; e++)t = new Date(1970, 0, 1, y.hour - (n - e) * p.hourStep), a.push({
                        date: t,
                        label: $(t, b),
                    ...
                    var o, i = [];
                    for (e = 0; e < p.length; e++)o = new Date(1970, 0, 1, 0, y.minute - (n - e) * p.minuteStep), i.push({
                        date: o,
                        label: $(o, k),
                    ...
                    g.rows = r, g.showAM = T, g.isAM = (d.$date || a[n].date).getHours() < 12, g.timeSeparator = D, d.$isBuilt = !0
                    ...
                    if (/(38|37|39|40|13)/.test(e.keyCode) && !e.shiftKey && !e.altKey) {
                        ...
                        var t = new Date(d.$date), n = t.getHours(), a = $(t, b).length, i = t.getMinutes(), r = $(t, k).length, s = /(37|39)/.test(e.keyCode), l = 2 + 1 * T;
        ...
        return {
            restrict: "EAC", require: "ngModel", link: function (e, t, n, l) {
                ...
                var p = d.lang, g = function (e, t) {
                    return a.formatDate(e, t, p)
                }, m = o({format: d.timeFormat, lang: p});
                angular.forEach(["minTime", "maxTime"], function (e) {
                    angular.isDefined(n[e]) && n.$observe(e, function (t) {
                        f.$options[e] = m.getTimeForAttribute(e, t), !isNaN(f.$options[e]) && f.$build(), u(l.$dateValue)
                    })
                }), e.$watch(n.ngModel, function () {
                    ...
                    var t;
                    return t = angular.isUndefined(e) || null === e ? 0 / 0 : angular.isDate(e) ? e : "string" === d.timeType ? m.parse(e, null, d.modelTimeFormat) : new Date("unix" === d.timeType ? 1e3 * e : e), l.$dateValue = t, c()
                }), l.$render = function () {
                    t.val(c())
                }, e.$on("$destroy", function () {
                    f && f.destroy(), d = null, f = null
