...
angular.module("angular-carousel", ["ngTouch", "angular-carousel.shifty"]), angular.module("angular-carousel").directive("rnCarouselAutoSlide", ["$timeout", function (a) {
    return {
        restrict: "A", link: function (b, c, d) {
            var e = Math.round(1e3 * parseFloat(d.rnCarouselAutoSlide)), f = increment = !1, g = c.children().length;
    ...
    return {
        restrict: "A", scope: {slides: "=", index: "=rnCarouselIndex"}, templateUrl: "carousel-indicators.html", link: function (b, c, d) {
        ...
        return {
            restrict: "A", scope: !0, compile: function (m, n) {
                ...
                return ["ng-repeat", "data-ng-repeat", "ng:repeat", "x-ng-repeat"].every(function (a) {
                    ...
                    function r(a) {
                        L = !0, A({x: a.clientX, y: a.clientY}, a)
                    }
                    ...
                    function v(a, b) {
                        ...
                        var c = new j;
                        c.tween({
                            from: {x: K}, to: {x: -100 * a}, duration: I.transitionDuration, easing: I.transitionEasing, step: function (a) {
                                u(a.x)
                            }, finish: function () {
                    ...
                    function A(a, b) {
                        if ((!b || L) && (c.unbind("mouseup", r), D = !1, L = !1, F = E - a.x, 0 !== F && !O))if (K += 100 * -F / M, I.isSequential) {
                            var d = I.moveTreshold * M, e = -F, f = -Math[e >= 0 ? "ceil" : "floor"](e / M), g = Math.abs(e) > d;
                    ...
                    var D, E, F, G, H = {
                        ...
                        bufferSize: 5,
                        moveTreshold: .1
                    }, I = angular.extend({}, H), J = !1, K = 0, L = !1, M = null, N = null, O = !1;
                    ...
                    a.bind(n, {
                        start: y, move: z, end: A, cancel: function (a) {
                            A({}, a)
                        }
                    ...
                    if (o.rnCarouselIndex) {
                        ...
                        angular.isFunction(U.assign) ? (m.$watch("carouselIndex", function (a) {
                            ...
                            void 0 !== a && null !== a && (G && a >= G.length ? (a = G.length - 1, T(a)) : G && 0 > a && (a = 0, T(a)), O || v(a, {animate: !Q}), Q = !1)
                        }), J = !0) : isNaN(o.rnCarouselIndex) || v(parseInt(o.rnCarouselIndex, 10), {animate: !1})
                    } else v(0, {animate: !Q}), Q = !1;
